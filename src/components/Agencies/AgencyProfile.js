            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
              ...
              <div>
                ...
                <input
                  ...
                  value={agencyData.establishedYear}
                  onChange={handleInputChange(setAgencyData)}
                  disabled={!isEditing}
                  className={`w-full px-3 py-2 border rounded-lg ${isEditing ? 'bg-white' : 'bg-gray-100'}`}
              ...
              {teamMembers.map((member, index) => (
                <div key={index} className="grid grid-cols-1 md:grid-cols-3 gap-4 items-center">
                  ...
                  <input
                    ...
                    onChange={(e) => handleInputChange((prev) => {
                      const updatedMembers = [...teamMembers];
                      updatedMembers[index] = { ...updatedMembers[index], email: e.target.value };
                      return updatedMembers;
                    })}
                    disabled={!isEditing}
                    className={`w-full px-3 py-2 border rounded-lg ${isEditing ? 'bg-white' : 'bg-gray-100'}`}
            ...
            {loading ? (
              ...
              <>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                  {fetchedPackages.map((pkg, index) => (
                    <div key={index} className="border rounded-lg p-4 space-y-4 bg-white shadow">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          Package Type
                        </label>
  ...
  return (
    <div className="max-w-6xl mx-auto p-4 sm:p-6 bg-white shadow-md rounded-lg">
      ...
      <div className="md:hidden mb-4">
        ...
        >
          <span className="font-medium">
            {activeSection === 'agency' && 'Agency Information'}
            {activeSection === 'team' && 'Team Members'}
            {activeSection === 'campaigns' && 'Campaigns'}
            {activeSection === 'payment' && 'Packages and Payments'}
          </span>
      ...
      <div className="flex flex-col md:flex-row gap-6">
        {/* Desktop Navigation */}
        <div className="hidden md:flex md:flex-col w-64 space-y-2">
          {[
            { icon: Building2, label: 'Agency', value: 'agency' },
            { icon: Users, label: 'Team', value: 'team' },
            { icon: Briefcase, label: 'Campaigns', value: 'campaigns' },
          ...
          <div className="md:hidden space-y-2 mb-4">
            {[
              ...
              <button
                ...
                className={`w-full flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors ${activeSection === tab.value
                  ? 'bg-blue-500 text-white'
                  : 'hover:bg-gray-100 text-gray-700'
                  }`}
              >
